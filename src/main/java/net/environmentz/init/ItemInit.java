...
public class ItemInit {
    ...
    public static final Item WOLF_CHESTPLATE = new WolfArmor(WOLF_ARMOR_MATERIAL, EquipmentSlot.CHEST, new Item.Settings().group(ItemGroup.COMBAT));
    public static final Item WOLF_LEGGINGS = new WolfArmor(WOLF_ARMOR_MATERIAL, EquipmentSlot.LEGS, new Item.Settings().group(ItemGroup.COMBAT));
    public static final Item WOLF_BOOTS = new WolfArmor(WOLF_ARMOR_MATERIAL, EquipmentSlot.FEET, new Item.Settings().group(ItemGroup.COMBAT));
    // Potion
