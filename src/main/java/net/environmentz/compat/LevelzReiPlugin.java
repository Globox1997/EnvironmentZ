...
public class LevelzReiPlugin implements REIClientPlugin {
    ...
    private static void addRecipe(DisplayRegistry registry, Item item) {
        ...
        //         itemStack2.setNbt(nbt);
        //         registry.add(new SmithingRecipe(new Identifier(Registries.ITEM.getId(item).getPath() + "_cooled"), Ingredient.ofStacks(itemStack), Ingredient.fromTag(TagInit.ICE_ITEMS), itemStack2));
        //     }
        // }
    }
