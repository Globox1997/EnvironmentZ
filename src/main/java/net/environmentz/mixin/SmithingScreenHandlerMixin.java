...
//         ItemStack itemStack2 = this.input.getStack(2);
...
//     private void getSlotFor(ItemStack stack, CallbackInfoReturnable<Integer> info) {
//         if (stack.isIn(TagInit.ICE_ITEMS) || stack.isIn(TagInit.INSOLATING_ITEM) || stack.getItem() instanceof ShearsItem) {
//             info.setReturnValue(2);
//         }
//     }

//     @Inject(method = "getQuickMoveSlot", at = @At("HEAD"), cancellable = true)
//     private static void getQuickMoveSlotMixin(SmithingRecipe recipe, ItemStack stack, CallbackInfoReturnable<Optional<Integer>> info) {
//         if (stack.isIn(TagInit.ICE_ITEMS) || stack.isIn(TagInit.INSOLATING_ITEM) || stack.getItem() instanceof ShearsItem) {
//             info.setReturnValue(Optional.of(2));
//         }
//     }

//     @Inject(method = "isValidIngredient", at = @At("HEAD"), cancellable = true)
//     private void isValidIngredient(ItemStack stack, CallbackInfoReturnable<Boolean> info) {
